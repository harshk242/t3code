...
This fork adds Linux `.deb` packaging and GNOME desktop integration. Before merging upstream changes, read [the fork upstream merge guide](docs/fork-upstream-merge-guide.md).

## Debugging

Live-app logs are written to `~/.t3/userdata/logs/`.
